...
The 8b-theme-mcp extension needs to function as both:
...
async function main() {
  ...
  console.error('8b-Theme-MCP standalone server started');
}
  ...
  const mcpProvider = vscode.lm.registerMcpServerDefinitionProvider(
    '8b-theme-mcp-provider',
    {
      ...
      async resolveMcpServerDefinition(
        ...
        console.log('8b-Theme-MCP server definition resolved');
        return definition;
      },
    }
  );
